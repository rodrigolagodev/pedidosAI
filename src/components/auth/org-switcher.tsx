...
export function OrgSwitcher({ currentOrg, organizations, compact = false }: OrgSwitcherProps) {
  ...
  if (compact) {
    return (
      <div className="relative" ref={menuRef}>
        ...
        {isOpen && (
          <div className="absolute right-0 mt-2 w-64 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 z-dropdown">
            <div className="py-1">
